...
function Labyrinth(size) {
    ...
    Object.defineProperty(this, "size", {
        get: function() {
            if (!parseInt(size) || parseInt(size) <= 1) {
                throw 'Please enter a valid interger value bigger than 1 for the size of the labyrinth';
            }
            return size;
        },
        set: function(value) {
...
Labyrinth.prototype.draw = function(parent) {
    document.getElementById(parent).style.width = (this.size * 50) + 'px';
    for (var i = 0; i < this.size; i++) {
        ...
        document.getElementById(parent).appendChild(separator);
    }
};
